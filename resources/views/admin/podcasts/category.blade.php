    ...
    <div class="container-fluid position-relative">
        ...
        <div class="col-12 col-lg-9 float-end pe-5 ps-5 ">
            ...
            <nav aria-label="breadcrumb" class="d-flex mt-3 fs-3 fw-bold" >
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" aria-current="page">Podacst Category</li>
                </ol>
            </nav>
            ...
            <table class="table table-hover col-12 table_custom">
                ...
                @foreach($podcast_categories as $podcast_category)
                    <tr>
                        <th class="fs-4" scope="row">{{$podcast_category->id}}</th>
                        <td class="fs-4 col-9">{{$podcast_category->title}}</td>
                        <td>
                            <!-- to edit the category -->
                            <a href="{{route('admin.podcast.category.edit', $podcast_category->id)}}">
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.podcast.categories.delete', $podcast_category->id) }}"
                                  method="post">
                                @csrf
                                @method('delete')
