...
<div class="container-fluid position-relative">
    ...
    <nav aria-label="breadcrumb" class="d-flex flex-row-reverse mt-3 fs-3 fw-bold" dir="ltr">
        <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page">ویرایش جواب پرسش‌ها</li>
        </ol>
    </nav>
        ...
        <div class="answer-text mt-3 p-3">
            ...
            <form action="{{route('admin.inquiries.update', $answer->id)}}" method="post" class="answer-items" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3 w-100" >
                    ...
                    <!-- category input -->
                    <input type="text" class="form-control text-center" placeholder="دسته بندی" name="category" value="{{$answer->category}}" required>
                    <!-- middle pic -->
