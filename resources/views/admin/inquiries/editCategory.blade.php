...
@section('content')
    <div class="container-fluid position-relative">
        ...
        <!-- category form -->
        <div class="col-12 col-lg-9 float-start pe-5 ps-5 ">
            {{--page title --}}
            <nav aria-label="breadcrumb" class="d-flex mt-3 fs-3 fw-bold">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" aria-current="page">Edit Ask Category</li>
                </ol>
            </nav>
            @include('errors.message')
                {{-- add category --}}
            <form action="{{ route('admin.inquiry.categories.update', $category->id) }}"
                ...
                <a href="{{route('admin.inquiries.category')}}">Back</a>
        </div>
