        ...
        <div class="col-12 col-lg-9 float-start pe-5 ps-5 " dir="ltr">
            ...
            <table class="table" dir="rtl">
                ...
                @foreach($webinar_categories as $webinar_category)
                    <tr>
                        <th class="fs-4" scope="row">{{$webinar_category->id}}</th>
                        <td class="fs-4 col-9">{{$webinar_category->title}}</td>
                        <td>
                            <!-- to edit the category -->
                            <a href="{{route('admin.webinar.category.edit', $webinar_category->id)}}">
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.webinar.categories.delete', $webinar_category->id) }}"
                                  method="post">
                                @csrf
                                @method('delete')
...
{{--                    </div>--}}
{{--                    <form action="{{ route('admin.webinar.categories.update', $webinar_category->id) }}" method="post">--}}
{{--                        <div class="modal-body input-group">--}}
{{--                            @csrf--}}
{{--                            @method('put')--}}
{{--                            <button class="btn btn-secondary col-4" type="submit" id="button-addon1">افزودن</button>--}}
{{--                            <input type="text" class="form-control col-8" name="title"--}}
{{--                                   placeholder="نام جدید دسته بندی را وارد کنید"--}}
{{--                                   aria-label="Example text with button addon"--}}
{{--                                   aria-describedby="button-addon1" dir="rtl" REQUIRED>--}}
