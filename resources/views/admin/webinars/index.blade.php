    ...
    <div class="contaienr-fluid position-relative">
        ...
        <div id="webinar-list" class="main-list col-12 col-lg-9 float-end pe-5 ps-5">
            ...
            <nav aria-label="breadcrumb" class="d-flex mt-3 fs-3 fw-bold" >
                <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page">Webinar List</li>
                </ol>
            </nav>
            ...
            <div class="list-page-titles d-flex justify-content-start p-3 text-center">
                ...
                <div class="h4 col-2">Modify Title</div>
            ...
            <div class="list-page-items d-flex justify-content-start align-items-center mt-3 p-4 text-center">
                ...
                <div class="display-4 col-2">{{$webinar->user_id}}</div>
                ...
                <div class="list-icons d-flex justify-content-around align-items-center col-3 pe-4 ps-4">
                    ...
                    <div class="list-down">
                        <a href="{{route('admin.webinars.download', $webinar->id)}}">
                    ...
                    <!-- to delete the item -->
                    <div class="list-del">
                        <form action="{{route('admin.webinars.delete', $webinar->id)}}" method="post">
                            @csrf
                            @method('delete')
