    ...
    <div class="container-fluid position-relative">
        ...
        <div class="col-12 col-lg-9 float-start pe-5 ps-5 " dir="ltr">
            ...
            <nav aria-label="breadcrumb" class="d-flex flex-row-reverse mt-3 fs-3 fw-bold" dir="ltr">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" aria-current="page">تغییر دسته‌بندی وبینارها</li>
                </ol>
            </nav>
            @include('errors.message')
                {{-- add category --}}
            <form action="{{ route('admin.webinar.categories.update', $category->id) }}"
                ...
                <a href="{{route('admin.webinars.category')}}">بازگشت به صفحه قبل</a>
        </div>
