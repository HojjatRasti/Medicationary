        ...
        <div id="webinar-up" class="col-12 col-lg-9 float-end pe-5 ps-5 ">
            ...
            <form action="{{ route('admin.post.update', $post->id) }}" id="article" method="post" class="d-flex justify-content-center flex-wrap mt-5" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3 w-100" >
                    <!-- title input -->
                    <input type="text" class="form-control text-center" placeholder="Title" name="title" value="{{$post->title}}" required>
                    <!-- middle pic -->
                ...
                <div class="col-xl-8 col-12 mb-3">
                    {{-- author input --}}
                    <input type="text" value="{{$post->author}}" class="form-control text-center mb-3 col-12" placeholder="Author" name="author" required>
                    <input type="text" value="{{$post->meta_title}}" class="form-control text-center mb-3 col-12" placeholder="Meta Title" name="meta_title" required>
                    <input type="text" value="{{$post->meta_description}}" class="form-control text-center mb-3 col-12" placeholder="Meta Description" name="meta_description" required>
                ...
                <!-- discription input -->
                <div class="col-8">
                    <textarea class="form-control" required rows="5" placeholder="Descriptions" name="abstract">{{$post->abstract}}</textarea>
                </div>
                <!-- file upload area -->
                <div class="col-10 mt-3 text-center">
                    <img src="/{{ $post->thumbnail_url }}" alt="" height="100px" width="100px" class="rounded mb-2" >
                    <br>
                    <label for="thumbnail_url">Blog Thumbnail</label>
                    <input class="form-control mt-3" type="file" id="formFileMultiple" name="thumbnail_url" multiple title="Add Thumbnail">
                   {{-- quill text editor --}}
