...
<div class="container-fluid position-relative" >
    ...
    <div  class="col-12 col-lg-9 float-start pe-5 ps-5 " dir="ltr">
        ...
        <form action="{{ route('admin.post.categories.store') }}" method="post" class="d-flex justify-content-center flex-wrap mt-3">
            @csrf
            {{-- add category --}}
            ...
            <div class="input-group mb-3 p-5 question-text border-start-0">
                ...
                <input type="text" class="form-control col-8" name="title" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" dir="rtl" REQUIRED>
            </div>
        </form>
