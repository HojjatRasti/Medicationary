        ...
        <div class="col-12 col-lg-9 float-start pe-5 ps-5 " dir="ltr">
            ...
            <form action="{{ route('admin.post.categories.store') }}" method="post"
                ...
                <div class="input-group mb-3 p-5 question-text border-start-0">
                    ...
                    <input type="text" class="form-control col-8" name="title" placeholder=""
                           aria-label="Example text with button addon" aria-describedby="button-addon1" dir="rtl"
                           REQUIRED>
                </div>
            </form>
            ...
            <table class="table table-hover col-12 table_custom"  dir="rtl">
                ...
                @foreach($post_categories as $post_category)
                    <tr>
                        <th class="fs-4" scope="row">{{$post_category->id}}</th>
                        <td class="fs-4 col-9">{{$post_category->title}}</td>
                        <td>
                            <!-- to edit the category -->
                            <a href="{{route('admin.post.category.edit', $post_category->id)}}">
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.post.categories.delete', $post_category->id) }}"
                                  method="post">
                                @csrf
                                @method('delete')
