    ...
    <div class="container-fluid position-relative">
        ...
        <div class="col-12 col-lg-9 float-end pe-5 ps-5 ">
            ...
            <nav aria-label="breadcrumb" class="d-flex mt-3 fs-3 fw-bold">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" aria-current="page">Edit Blog Category</li>
                </ol>
            </nav>
            @include('errors.message')
                {{-- add category --}}
            <form action="{{ route('admin.post.categories.update', $category->id) }}"
                ...
                <a href="{{route('admin.post.category')}}">Back</a>
            </form>
        </div>
