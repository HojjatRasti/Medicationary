...
<div class="container-fluid position-relative" >
    ...
    <div id="webinar-up" class="col-12 col-lg-9 float-end pe-5 ps-5 " >
        ...
        <nav aria-label="breadcrumb" class="d-flex mt-3 fs-3 fw-bold" >
            <ol class="breadcrumb">
            <li class="breadcrumb-item" aria-current="page">Upload Blog</li>
            </ol>
        </nav>
        ...
        <form action="{{ route('admin.post.store') }}" id="article" method="post" class="d-flex justify-content-center flex-wrap mt-5" enctype="multipart/form-data">
            ...
            <div class="col-xl-8 col-12 mb-3">
                {{-- author input --}}
                <input type="text" class="form-control text-center mb-3 col-12" placeholder="Author" name="author" required>
            ...
            <!-- discription input -->
            <div class="col-8">
                <textarea class="form-control" required rows="2" cols="8" placeholder="Description" name="abstract"></textarea>
            </div>
            <!-- file upload area -->
