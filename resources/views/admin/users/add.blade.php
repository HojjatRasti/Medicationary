            ...
            <form action=" {{ route('admin.users.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex flex-wrap justify-content-between mt-5">
                    ...
                    <div class="col-md-3 col-12">
                        <input class="form-control m-3" type="text" name="name" placeholder="First & Last name">
                ...
                <div class="mt-5 d-flex flex-column text-center ">
                    <div class="form-group ">
                        <textarea name="description"  cols="50" rows="5" placeholder=""></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="text-center mt-5">
                    <button type="submit" class="btn btn-success w-25 p-3">Submit</button>
                </div>
