    <!-- footer -->
  <footer class="text-white w-100 d-flex flex-wrap" id="footer">
    <!-- Grid container -->
    ...
    <!-- Copyright -->
    <div class="text-center col-12 " style="background-color: rgba(0, 0, 0, 0.2);">
      تمامی حقوق برای <p class="display-4 d-inline">...</p> محفوظ است.
    </div>
    <!-- Copyright -->
  </footer>
