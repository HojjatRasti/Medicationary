   <!-- sidebar -->
   <button type="button" id="sidebarBtn" class="sidebar col-3 col-sm-2 h-auto p-2 btn btn-dark d-block d-lg-none m-3 ms-0">
   ...
   <nav id="sidebarElements" class="sidebar d-none d-lg-block col-lg-3 col-md-4 col-12  position-fixed d-flex flex-column justify-content-center align-items-center  overflow-scroll  z-3 ">
    <!-- sidebar title -->
    <div id="aide-header" class=" d-flex justify-content-center mt-lg-5">
     <a class="fs-4 " href="{{ route('admin.index.landscape') }}" title="برگشت به صفحه اصلی سایت" >Medicationary</a>
    ...
    <div id="sidebar-items" class="d-flex flex-wrap justify-content-around">
      <!-- webinar menu -->
      <button type="button" id="web-btn" class="btn col-10 d-block mt-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#webinar-item">
        ...
        <p class="d-inline text-center pt-3">Webinar</p>

        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="48" viewBox="0 0 12 24"><path fill="currentColor" fill-rule="evenodd" d="M10.157 12.711L4.5 18.368l-1.414-1.414l4.95-4.95l-4.95-4.95L4.5 5.64l5.657 5.657a1 1 0 0 1 0 1.414" stroke-width="0.5" stroke="currentColor"/></svg>
      ...
      <!-- blog menu -->
      <button type="button" id="blog-btn" class="btn col-10 d-block mt-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#blog-item">
        ...
        <p class="d-inline text-center pt-3">Blog</p>
      ...
      <!-- ask menu -->
      <button type="button" id="ask-btn" class="btn col-10 d-block mt-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#ask-item">
        ...
        <p class="d-inline text-center pt-3">Ask</p>
      ...
      <!-- podcast menu -->
      <button type="button" id="pod-btn" class="btn col-10 d-block mt-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#podcast-item">
        ...
        <p class="d-inline text-center pt-3">Podcast</p>
      ...
      <!-- users menu -->
      <button type="button" id="user-btn" class="btn col-10 d-block mt-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#users-item">
        ...
        <p class="d-inline text-center pt-3">Users</p>
